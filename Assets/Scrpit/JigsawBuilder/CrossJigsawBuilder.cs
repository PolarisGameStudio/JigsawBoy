...
public class CrossJigsawBuilder : BaseJigsawBuilder
{
    private float crossWith;

    public CrossJigsawBuilder() : base()
    {
        crossWith = 0.3f;
    }
    ...
    {
        return base.baseBuildJigsawList(JigsawStyleEnum.Cross, horizontalJigsawNumber, verticalJigsawNumber, jigsawPic);
    }
