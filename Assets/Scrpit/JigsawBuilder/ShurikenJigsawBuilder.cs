...
public class ShurikenJigsawBuilder : BaseJigsawBuilder
{
    ...
    {
        return base.baseBuildJigsawList(JigsawStyleEnum.Shuriken, horizontalJigsawNumber, verticalJigsawNumber, jigsawPic);
    }
    ...
    private void getBulgeVertices(List<Vector3> listVertices, JigsawBulgeEnum jigsawBulge, Direction2DEnum direction, float withX, float highY)
    {
        ...
        //TODO 添加传统拼图形状
        leftConcavePositionList.Add(new Vector3(-withX,-0.01f));
        leftConcavePositionList.Add(new Vector3(-withX-0.35f, -0.15f));
        leftConcavePositionList.Add(new Vector3(-withX - 0.5f, -0.5f));
        leftConcavePositionList.Add(new Vector3(-withX - 0.65f, -0.15f));
