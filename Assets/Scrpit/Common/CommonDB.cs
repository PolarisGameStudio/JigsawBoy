...
public class CommonDB
{
    ...
    public static readonly string PuzzleInfoDB_Details_Food_Table = "details_food";
    public static readonly string PuzzleInfoDB_Details_StarrySky_Table = "details_starrysky";
